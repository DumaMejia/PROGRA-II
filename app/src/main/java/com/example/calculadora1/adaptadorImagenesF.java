...
public class adaptadorImagenesF extends BaseAdapter {
    Context context;
    ArrayList<usuarios> datos;
    LayoutInflater layoutInflater;
    usuarios user;

    public adaptadorImagenesF(Context context, ArrayList<usuarios> datos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tempVal = itemView.findViewById(R.id.lblnombreP);
